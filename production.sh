...
while [ 1 ]; do
	LOG=$(cat /home/smokecode/Desktop/bash-scripts/king.txt)
	if [[ $LOG != $NAME ]]; then
		echo "[*] modification observed."
		echo $NAME > /home/smokecode/Desktop/bash-scripts/king.txt #puts your username back into the file
